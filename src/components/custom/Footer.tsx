            ...
            <footer className="p-4 pb-30">
                ...
                <div className="flex flex-wrap gap-5 lg: justify-between">
                    ...
                    <div>
                        ...
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Для исполнителей</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Для разработчиков</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Реклама</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Для инвесторов</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Для вендоров</a>
                    </div>
                    <div>
                        <h3 className="my-text mt-9 mb-3 font-bold text-[16px] ">Полезные ссылки</h3>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Справка</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Бесплатное  мобильное приложение</a>
                    </div>

                    <div>
                        <h3 className="my-text mt-9 mb-3 font-bold text-[16px] ">План Spotify</h3>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Индивидуальная подписка Spotify Premium</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Premium для двоих</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Premium для семьи</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Premium для студентов</a>
                        <a href="#" className="my-text block font-normal text-[14px] mb-1.5 ml-1 text-[#9e928f]">Бесплатная версия Spotify</a>
                    </div>
                ...
                <hr className="border-0 h-[1px] bg-[#292929] mt-8" />
